...
const NavBar = () => {
    ...
    return (
        <div className="navbar opacity-95 bg-black text-white h-40">
            <div className="navbar-start">
                ...
                <Link to={'/'} className="btn btn-ghost normal-case text-xl heading-font">
                    <Typography display="inline">
                        <Box className='heading-font text-[#DD6E8B] text-5xl' sx={{ letterSpacing: 6, display: 'inline-block' }}> <span className='flex items-center justify-center'>Sw<GiSpoon></GiSpoon>ft</span> <span style={{ fontFamily: 'Ephesis, cursive' }}>Bite</span></Box>
                    </Typography>
                </Link>
            </div>
